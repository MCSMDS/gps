...
public class GpsapiPlugin implements MethodCallHandler, PluginRegistry.RequestPermissionsResultListener {
    ...
    private GpsapiPlugin(Registrar registrar) {
        this.registrar = registrar;
        this.registrar.addRequestPermissionsResultListener(this);
    }

    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "gpsapi");
        channel.setMethodCallHandler(new GpsapiPlugin(registrar));
    }
